...
from .configuration_bert import BiobertConfig
from .file_utils import add_start_docstrings

logger = logging.getLogger(__name__)

BIOBERT_PRETRAINED_MODEL_ARCHIVE_MAP = {
    'biobert': "/home/ying/PycharmProjects/biobert_v1.1_pubmed/pytorch_model.bin",
}
...
class BiobertPreTrainedModel(PreTrainedModel):
...
class BiobertModel(BiobertPreTrainedModel):
    r"""
...
class BiobertForPreTraining(BiobertPreTrainedModel):
    r"""
...
@add_start_docstrings("""Bert Model with a `language modeling` head on top. """,
                      BERT_START_DOCSTRING,
                      BERT_INPUTS_DOCSTRING)
class BiobertForMaskedLM(BiobertPreTrainedModel):
    r"""
        **masked_lm_labels**: (`optional`) ``torch.LongTensor`` of shape ``(batch_size, sequence_length)``:
            Labels for computing the masked language modeling loss.
            Indices should be in ``[-1, 0, ..., config.vocab_size]`` (see ``input_ids`` docstring)
...
@add_start_docstrings("""Bert Model with a `next sentence prediction (classification)` head on top. """,
                      BERT_START_DOCSTRING,
                      BERT_INPUTS_DOCSTRING)
class BiobertForNextSentencePrediction(BiobertPreTrainedModel):
    r"""
        **next_sentence_label**: (`optional`) ``torch.LongTensor`` of shape ``(batch_size,)``:
            Labels for computing the next sequence prediction (classification) loss. Input should be a sequence pair (see ``input_ids`` docstring)
            Indices should be in ``[0, 1]``.
...
@add_start_docstrings("""Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of
                      ...
                      BERT_START_DOCSTRING,
                      BERT_INPUTS_DOCSTRING)
class BiobertForSequenceClassification(BiobertPreTrainedModel):
    r"""
...
@add_start_docstrings("""Bert Model with a multiple choice classification head on top (a linear layer on top of
                      ...
                      BERT_START_DOCSTRING,
                      BERT_INPUTS_DOCSTRING)
class BiobertForMultipleChoice(BiobertPreTrainedModel):
    r"""
        **labels**: (`optional`) ``torch.LongTensor`` of shape ``(batch_size,)``:
...
@add_start_docstrings("""Bert Model with a token classification head on top (a linear layer on top of
                      ...
                      BERT_START_DOCSTRING,
                      BERT_INPUTS_DOCSTRING)
class BiobertForTokenClassification(BiobertPreTrainedModel):
    r"""
...
@add_start_docstrings("""Bert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layers on top of
                      ...
                      BERT_START_DOCSTRING,
                      BERT_INPUTS_DOCSTRING)
class BiobertForQuestionAnswering(BiobertPreTrainedModel):
    r"""
