...
class pretrain_dataset(Dataset):
    def __init__(self, args, D, batch_size=None):
        ...
        if args.model_no == 0:
            ...
            from .model.BIOBERT.tokenization_bert import BertTokenizer as Tokenizer
            model = 'biobert'
            lower_case = False
            model_name = 'BIOBERT'
        ...
        if os.path.isfile(tokenizer_path):
            ...
            self.tokenizer.add_tokens(['[E1]', '[/E1]', '[E2]', '[/E2]', '[BLANK]','[disease]','[chemical]'])
